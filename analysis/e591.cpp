...
// _0823:
inline void _0823() {
  Reg::R5_R4::set(Reg::R1_R0::get());
  Reg::R3_R2::set(Reg::CC3::Inst);
...
inline void ExtInt6_NonEvenZeroCross() {
  ...
  if (!CHECK_BIT_AT(RAM[0x25], 1)) {
    ...
    if (RAM[0x30] != 4) {
      ...
      if ((R4 >> 1) > R0) {
        // _090C:
        // r4_shr_1_less_than_r0:
        word Sum = WORD(Diff) + WORD(R4);
        ...
        if (Sum > 0xFF) {
          ...
          if (R6 != 0x38) {
            ...
            if (R6 >= 0x38) {
              ...
              if (R6 != 0x3B) {
                ...
                if (CHECK_BIT_AT(RAM[0x25], 5)) {
                  // _095C:
                  location::AsWord<seg::RAM, 0x44>::set(R3_R2 - location::AsWord<seg::RAM, 0x46>::get());
                }
              ...
              if (Reg::R7::get() != 0x1E) {
                ...
                // r5_less_than_4:
                // _09C5:
                if (!CHECK_AND_CLEAR_BIT(&RAM[0x25, 4]) && Reg::R7::get() == RAM[0x36]) {
                  // _09D5:
                ...
                if (Reg::R6::get() != R0_bank2) {
                  ...
                  if (Reg::R6::get() != R2_bank2) {
                    ...
                    if (Reg::R6::get() != R7_bank1) {
                      ...
                      if (!CHECK_BIT_AT(RAM[0x2E], 1)) {
                        ...
                        RAM[0x6D] = FLASH[0x0785 + R6(bank2)] - 1;
                    ...
                    goto r6_bank_3_neq_r6_bank_2_impl; // _0B58 TODO
                  }
                } else {
                  // _09EC:
                  SET_BIT_IN(P5, 4);
                  Reg::R1_R0::set((QUAD(Reg::R5_R4::get()) << 1) * Reg::R1Sel<2>::get() / 256);

                  // _0A11:
                  Reg::R1_R0::set(Reg::R1_R0::get() + Reg::R3_R2::get());

                  if (Reg::R5Sel<2>::get() < 2) {
                    RAM[0x5C] = Reg::R5Sel<2>::get();
                  } else {
                    RAM[0x5C] = Reg::R5Sel<2>::get() - 2;
                  }
                  ...
                  goto r6_bank_3_neq_r0_bank_2_impl; // _0AC5 TODO
                }
              } else {
                Reg::R7::get() = 0;
                ++RAM[0x33];
            ...
            Reg::CC3::Inst = Reg::R3_R2::get() + Reg::R5_R4::get();
            // IRCON0.IEX6 = 0
          ...
          goto r5_r4_less_than_ram_32_ram_31; // _086E TODO
        }
      } else {
        // _084B:
        if (CHECK_BIT_AT(RAM[0x26], 1)) {
          goto ram_26_1_set; // _086A TODO
        } else if (CHECK_BIT_AT(RAM[0x26], 0)) {
          goto ram_26_0_set; // _0866 TODO
        } else {
      ...
      Ram31WordT::set(Reg::R1_R0::get() - Reg::R5_R4::get());
      if (Reg::R1_R0::get() >= Reg::R5_R4::get()) {
        // _0856:
        // r1_r0_was_greater_or_equal_than_r5_r4:
        if (Reg::R5_R4::get() < Ram31WordT::get()) {
          // _086E:
        ...
        // _0839:
        quad Sum = QUAD(Ram31WordT::get()) + (Reg::R5_R4::get() >> 1);

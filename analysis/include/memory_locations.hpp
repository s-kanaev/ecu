...
DEFINE_MEMORY_WORD(XRAM, ADC_POT_SUM, 0xF6A4);
...
////////////////////////////////////////////////////////////
// FLASH
DEFINE_MEMORY_RANGE(FLASH, COOLANT_TEMPERATURE_1, 0x831F, 0x832F);
DEFINE_MEMORY_RANGE(FLASH, COOLANT_TEMPERATURE_2, 0x8330, 0x8340);
DEFINE_MEMORY_RANGE(FLASH, INTAKE_AIR_TEMPERATURE, 0x8341, 0x8351);

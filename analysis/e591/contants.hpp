...
static constexpr byte SyncDiscLastTooth = SyncDiscTeethCount - 1;
static constexpr byte SyncDiscMissingTeethCount = 2;
static constexpr byte SyncDiscLastRealTooth =
    SyncDiscTeethCount - SyncDiscMissingTeethCount - 1;
static constexpr byte SyncDiscLastRealToothMinus1 = SyncDiscLastRealTooth - 1;
} // namespace Const

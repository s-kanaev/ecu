...
DEFINE_MEMORY_WORD_METHODS(XRAM, THROTTLE_POSITION_LESS_THRESHOLD_2);
...
DEFINE_MEMORY_WORD_METHODS(XRAM, FILTERED_THROTTLE_POSITION_LESS_THRESHOLD_1);
DEFINE_MEMORY_WORD_METHODS(XRAM, FILTERED_THROTTLE_POSITION_LESS_THRESHOLD_2);
DEFINE_MEMORY_WORD_METHODS(XRAM, FILTERED_THROTTLE_POSITION_LESS_THRESHOLD_3);

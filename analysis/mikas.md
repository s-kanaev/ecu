...
Реле управляется с клеммы 46 подачей "минуса" с ноги `OUT5` ИС HIP0045.

##### Реле ЭБН

Реле управляется с клеммы 3 подачей "минуса" с ноги `OUT7` ИС HIP0045.

##### Реле муфты электровентилятора

Реле управляется с клеммы 33 подачей плюса (?) с ноги `OUT3` ИС HIP0045.

##### Реле муфты кондиционера

Реле управляется с клеммы 25 подачей плюса (?) с ноги `OUT2` ИС HIP0045.
...
Их две.
Одна для управления РХХ и ... . Вторая - управляет форсунками.

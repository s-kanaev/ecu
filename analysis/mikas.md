...
| `!IN1`  | `P5.0`    |               | КЗ 2/3   | `0 => 1`              |
| `!IN2`  | `P5.1`    |
| `OUT1`  | `P7.4`    | 20            | КЗ 2/3   | Катушка питается при "0" на соответствующем входе TPS-ины. Искрообразование происходит при переходе `0 => 1` |
| `OUT2`  | `P7.5`    | 1             | КЗ 1/4   |
...
4. Назначение `PSW.5` ?
5. Назначение `RAM[7E]`, `RAM[7F]` - инициализируются значением `0x40`
6. Назначение `RAM[7C..7F]` - ?
